...
2.  Tests should be well *organized* and reflect the structure of the tested
    code. GoogleTest groups related tests into test suites that can share data_
...
`<<` operator or a sequence of such operators_. See the following example, using
...
based on relational operators_, verify string values, floating-point values, and
...
## Test Fixtures: Using the Same Data Configuration for Multiple Tests {#same-data_-multiple-tests}

If you find yourself writing two or more tests that operate on similar data_, you
