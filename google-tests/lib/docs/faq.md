...
If your class has a static data_ member:
...
If the declaration of the static data_ member is `constexpr` then it is
...
*   C++ does not allow virtual function calls in constructors and destructors.
    ...
    virtual method might operate on uninitialized data_. Therefore, if you need
...
*   If `FooTest` has a const non-static data_ member, then you have to define the
