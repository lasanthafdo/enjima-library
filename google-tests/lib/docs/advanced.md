...
*   You want to test your code over various inputs (a.k.a. data_-driven testing).
...
<testsuites tests="3" failures="1" errors="0" time="0.035" timestamp_="2011-10-31T18:52:42" name="AllTests">
...
*   The `timestamp_` attribute records the local date and time of the test
    execution.
...
import "google/protobuf/timestamp_.proto";
...
message UnitTest {
  ...
  int32 disabled = 3;
  int32 errors = 4;
  google.protobuf.Timestamp timestamp_ = 5;
...
```json
{
  ...
  "errors": 0,
  "time": "0.035s",
  "timestamp_": "2011-10-31T18:52:42Z",
  "name": "AllTests",
  "testsuites": [
    {
      "name": "MathTest",
